...
export function buildAnimationTimelines(
    ...
    finalStyles: ɵStyleData = {}, locals: {[name: string]: any},
...
const DEFAULT_NOOP_PREVIOUS_NODE = <AnimationAst>{};
export class AnimationTimelineContext {
  ...
  updateLocals(newLocals?: {[name: string]: any}, skipIfExists?: boolean) {
    if (!newLocals) return;
  ...
  createSubContext(locals?: {[name: string]: any}, element?: any, newTime?: number):
...
export class AnimationTimelineBuilderVisitor implements AnimationAstVisitor {
  ...
  visitAnimate(ast: AnimationAnimateAst, context: AnimationTimelineContext) {
    ...
    if (style instanceof AnimationKeyframesSequenceAst) {
      ...
      this.visitStyle(style as AnimationStyleAst, context);
    }
  ...
  private _applyStyles(
      styles: (ɵStyleData|string)[], easing: string|undefined, treatAsEmptyStep: boolean,
  ...
  visitQuery(ast: AnimationQueryAst, context: AnimationTimelineContext) {
    ...
    let furthestTime = startTime;
    const elms = invokeQuery(context.element, ast.selector, ast.multi, ast.includeSelf);
...
export class TimelineBuilder {
  ...
  setStyles(
      input: (ɵStyleData|string)[], easing: string|undefined, treatAsEmptyStep: boolean,
      errors: any[], locals?: {[name: string]: any}) {
    if (easing) {
