 ...
 */
import {AUTO_STYLE, AnimateTimings, AnimationAnimateChildMetadata, AnimationAnimateMetadata, AnimationGroupMetadata, AnimationKeyframesSequenceMetadata, AnimationMetadata, AnimationMetadataType, AnimationQueryMetadata, AnimationReferenceMetadata, AnimationSequenceMetadata, AnimationStaggerMetadata, AnimationStateMetadata, AnimationStyleMetadata, AnimationTransitionMetadata, AnimationTriggerMetadata, style, ɵStyleData} from '@angular/animations';
...
export class AnimationAstBuilderVisitor implements AnimationDslVisitor {
  ...
  visitSequence(metadata: AnimationSequenceMetadata, context: AnimationAstBuilderContext):
    ...
    const ast =
        new AnimationSequenceAst(metadata.steps.map(s => visitAnimationNode(this, s, context)));
  ...
  visitGroup(metadata: AnimationGroupMetadata, context: AnimationAstBuilderContext):
    ...
    const ast = new AnimationGroupAst(steps);
    if (metadata.locals && Object.keys(metadata.locals).length) {
      ast.locals = metadata.locals;
    }
    return ast;
  ...
  visitAnimate(metadata: AnimationAnimateMetadata, context: AnimationAstBuilderContext):
    ...
    let styles: AnimationStyleAst|AnimationKeyframesSequenceAst;
  ...
  private _makeStyleAst(metadata: AnimationStyleMetadata, context: AnimationAstBuilderContext):
    ...
    let collectedEasing: string|undefined;
  ...
  visitAnimateChild(metadata: AnimationAnimateChildMetadata, context: AnimationAstBuilderContext):
    ...
    let animationArg: AnimationReferenceMetadata|undefined;
    let locals: {[name: string]: any}|undefined;
    let arg: any;
    ...
    switch (countArgs(args)) {
      ...
      case 2:
        ...
        if (arg['type'] == AnimationMetadataType.Reference) {
          // animateChild(definition, locals)
          animationArg = arg as AnimationReferenceMetadata;
          locals = normalizeLocals(args[1] as{[name: string]: any});
        }
        break;
    }
    const animation = animationArg ? this.visitReference(animationArg, context) : undefined;
  ...
  visitQuery(metadata: AnimationQueryMetadata, context: AnimationAstBuilderContext):
    ...
    const ast = new AnimationQueryAst(selector, metadata.multi, includeSelf, entry);
    if (metadata.locals && Object.keys(metadata.locals).length) {
      ast.locals = metadata.locals;
    }
    return ast;
  ...
  visitStagger(metadata: AnimationStaggerMetadata, context: AnimationAstBuilderContext):
    ...
    switch (countArgs(metadata.args)) {
      ...
      default:
        ...
        timings = resolveTiming(metadata.args[0] as string, context.errors, true);
...
function normalizeLocals(obj: {[key: string]: any} | undefined): {[key: string]: any}|undefined {
...
export class AnimationAstBuilderContext {
  ...
  public currentAnimateTimings: AnimationTimingAst|null = null;
...
function consumeOffset(styles: ɵStyleData | string | (ɵStyleData | string)[]): number|undefined {
