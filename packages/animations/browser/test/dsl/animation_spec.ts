 ...
 */
import {AUTO_STYLE, AnimationMetadata, AnimationMetadataType, animate, animateChild, animation, group, keyframes, query, queryAll, sequence, stagger, style, ɵStyleData} from '@angular/animations';
